            ...
            <div className="grid gap-8 md:grid-cols-2 md:gap-4">
              <div className="flex flex-col gap-4 rounded-md border border-solid bg-gray-100 p-6 md:p-4">
                <p className="text-sm">
                  ...
                  Debitis, fuga in, hic veniam accusamus facere atque quidem
                  dolorem asperiores vel sint nisi sit incidunt autem? Quos
                  laborum enim quod iure in odit inventore cumque, amet eius
                  delectus, corporis obcaecati
                </p>
